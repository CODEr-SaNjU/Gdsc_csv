    ...
    if request.method == 'POST' and request.FILES['files']:
        ...
        if os.path.exists(uploaded_file_url)==True:
            with open(uploaded_file_url,'r') as csvfile:
                ...
                # print(" testing ",basefilename,file_extension)
                # chars= 'Download'
...
def e2k_File(request):
    if request.method == 'POST' and request.FILES['files']:
        ...
        if os.path.exists(uploaded_file_url)==True:
            ...
            # print(Control_filelist)
            Control_filelist1 = dict1['$ CONTROLS']
            print("line 107 ",Control_filelist1)
            for line in range(2):
                if 'UNITS' in Control_filelist1[line]:
                    ...
                    print("line number 110",Force_unit)
                    print("line number 111",Length_unit)
                    break
            ...
            # print("line number is 116",unitforforces_df )
            # print("line number is 124",forcefactor)
            # print("line number is 125 ",KGfactor)
